...
exports.AuthorizationValidateRule = exports.AuthorizationFilterRule = exports.BaseAuthorizationRule = exports.AuthorizationAnnotation = exports.AuthorizationValidateOperationRule = exports.AuthorizationFilterOperationRule = exports.AuthorizationAnnotationArguments = void 0;
...
exports.BaseAuthorizationRule = BaseAuthorizationRule;
class AuthorizationFilterRule extends BaseAuthorizationRule {
    constructor({ operations, ...rest }) {
        super({
            operations: operations ?? [...exports.AuthorizationFilterOperationRule],
            ...rest,
        });
    }
}
exports.AuthorizationFilterRule = AuthorizationFilterRule;
class AuthorizationValidateRule extends BaseAuthorizationRule {
    constructor({ operations, when, ...rest }) {
        super({
            operations: operations ?? [...exports.AuthorizationValidateOperationRule],
            ...rest,
        });
