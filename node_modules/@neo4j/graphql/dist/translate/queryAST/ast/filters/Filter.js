...
exports.isLegacyRelationshipOperator = isLegacyRelationshipOperator;
exports.isRelationshipOperator = isRelationshipOperator;
const QueryASTNode_1 = require("../QueryASTNode");
const LEGACY_RELATIONSHIP_OPERATORS = ["ALL", "NONE", "SINGLE", "SOME"];
const RELATIONSHIP_OPERATORS = ["all", "none", "single", "some"];
function isLegacyRelationshipOperator(operator) {
    return LEGACY_RELATIONSHIP_OPERATORS.includes(operator);
}
